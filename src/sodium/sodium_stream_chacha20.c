...
#include "sodium/sodium_private_implementations.h"
#include "sodium/sodium_randombytes.h"
#include "sodium/sodium_runtime.h"
#include "sodium/sodium_stream_chacha20.h"
#include <stdio.h>

#include "sodium/sodium_chacha20-ref.h"
#if defined(HAVE_AVX2INTRIN_H) && defined(HAVE_EMMINTRIN_H) && \
    defined(HAVE_TMMINTRIN_H) && defined(HAVE_SMMINTRIN_H)
# include "sodium/sodium_dolbeau_chacha20-avx2.h"
#endif
#if defined(HAVE_EMMINTRIN_H) && defined(HAVE_TMMINTRIN_H)
# include "sodium/sodium_dolbeau_chacha20-ssse3.h"
#endif
