...
#include "sodium/sodium_stream_salsa20.h"
#include <stdio.h>

#ifdef HAVE_AMD64_ASM
# include "sodium/sodium_salsa20-xmm6.h"
#else
# include "sodium/sodium_salsa20-ref.h"
#endif
#if !defined(HAVE_AMD64_ASM) && defined(HAVE_EMMINTRIN_H)
# include "sodium/sodium_xmm6int_salsa20-sse2.h"
#endif
#if defined(HAVE_AVX2INTRIN_H) && defined(HAVE_EMMINTRIN_H) && \
    defined(HAVE_TMMINTRIN_H) && defined(HAVE_SMMINTRIN_H)
# include "sodium/sodium_xmm6int_salsa20-avx2.h"
#endif
